...
**Research Journey:** My long-term goal is to develop interpretable, generalizable, and robust machine learning systems. I have pursued this goal across diverse data modalities, including images :framed_picture:, audio :studio_microphone:, and graph :dna:, and I now focus on foundation models and time series :chart_with_upwards_trend:. I am always excited to explore new ideas and draw inspiration from different domains.
